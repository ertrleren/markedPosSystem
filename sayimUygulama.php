...
<nav class="links" style="--items: 5;">
		...
		<a href="http://localhost/buselpos/deneme">YENİLENİYOR</a>
...
<form  method="post" >
  <label for="barkod"><b>Barkod No:</b></label>
  <input type="text"  name="kod" id="barkod" value=""><br><br>
  <label for="adet"><b>Urun  Adi   :</b></label>
  <input type="text"  name="ad" value=""><br><br>
  <label for="adet"><b>Urun Adet :</b></label>
  <input type="text"  name="adet" value=""><br><br>
 <br>
  <input type="submit" style="background-color:DimGray ;color:white;width:30%;" name="buton" >
</form> 
</div>
...
if (isset($_POST["buton"])) {
	...
	$sqlUrunVarmi = "SELECT * FROM sayim WHERE barkod_no=" . $_POST['kod'] . "";
	$result = mysqli_query($baglan, $sqlUrunVarmi);
	if (mysqli_num_rows($result) > 0) {
		echo "Bu Barkod Zaten Var";
	} else {
...
Quagga.init({
    ...
    decoder : {
	  ...
	  Quagga.onDetected(function(data){
			...
			$("#barkod").val(data['codeResult']['code']);
